...
1 x Makerboard
1 x TEA5767 (Radio)
1 x 3.5mm Audio Jack (one stripped end to connect left/right/black separately)
1 x 3.5mm Audio Jack to Radio Antenna
1 x Si470x (RDS)
